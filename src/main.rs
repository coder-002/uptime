...
async fn main(){
    let monitors = vec![
        ...
        Monitor{id: 3, name: "test".into(), url: "https://youtu.com".into(), interval_secs:5, timeout_secs:5, monitor_type: MonitorType::Http { method: HttpMethod::Get, keyword: None }, retries: 1},
